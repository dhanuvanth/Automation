...
def Corona(countries):
    driver = webdriver.Chrome(r'C:\Users\Dhanu\Downloads\chromedriver.exe')
    driver.minimize_window()
    driver.get("https://www.worldometers.info/coronavirus/")
    sleep(2)
    for i in range(1,300):
                country = driver.find_element_by_xpath(('//*[@id="main_table_countries_today"]/tbody[1]/tr[{0}]/td[2]'.format(str(i))))
...
def send_mail(country_element, total_cases, total_deaths, active_cases, total_recovered):
    ...
    server.login('zbogets@gmail.com', 'Legends@3')
